<template>
  <div>
    ...
    <el-form :model="dynamicValidateForm" ref="dynamicValidateForm" label-width="100px">
      <el-form-item v-for="(domain, index) in dynamicValidateForm.domains" :key="domain.index"
                    :label="'规格参数:' + index" :prop="'domains.' + index + '.value'"
        ...
        <div v-for="(item, index1) in dynamicValidateForm.domains[index].children" :key="index1" :label="'参数 ' + index1"
             :prop="'children.' + index1 +  '.childValue'" :rules="{required: true, message: 'childValue不能为空', trigger: 'blur'}">
